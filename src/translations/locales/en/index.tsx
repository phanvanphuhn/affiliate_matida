...
export const en = {
  ...
  home: {
    ...
    yourtaskThisWeek: 'Your tasks this week',
    exploreAndLearn: 'Explore & Learn',
    recommendByOurEx: 'Recommended by our experts',
    testYourKnowledge: 'Test your knowledge',
    getSupport: 'Get support',
    getSupportNewBorn: 'Get support',
    upcomingLiveTalks: 'Upcoming live talks',
    whatMomsTalkAbout: 'What moms talk about',
    dueOn: 'Due on:',
    weeklyTracker: 'Weekly Tracker',
    dates: 'Dates',
    body: 'Body',
    newbornTracker: 'Newborn tracker',
  },
  sizeComparison: {
    week: 'Week',
  ...
  error: {
    ...
    pleaseEnterBabyMonth: 'Please enter your baby month',
    babyMonthCannotLower: 'Baby month cannot be lower than 1',
  },
  deal: {
    by: 'by',
    getDeal: 'Get Deal',
