export const vi = {
  ...
  home: {
    ...
    trimester: ['Tam cá nguyệt 1', 'Tam cá nguyệt 2', 'Tam cá nguyệt 3'],
    ...
    pregnancyTracker: 'Theo dõi thai kỳ',
    yourtaskThisWeek: 'Nhiệm vụ tuần này',
    exploreAndLearn: 'Khám phá kiến thức',
    recommendByOurEx: 'Gợi ý bởi chuyên gia',
    testYourKnowledge: 'Thử thách kiến thức',
    getSupport: 'Hỏi đáp thai kỳ',
    getSupportNewBorn: 'Hỏi đáp về em bé',
    upcomingLiveTalks: 'Livestream sắp diễn ra',
    whatMomsTalkAbout: 'Các mẹ nói gì',
    dueOn: 'Ngày dự sinh:',
    weeklyTracker: 'Theo dõi hằng tuần',
    dates: 'Lịch thai kỳ',
    body: 'Cơ thể mẹ',
    newbornTracker: 'Theo dõi em bé',
  },
  sizeComparison: {
    week: 'Tuần',
  ...
  error: {
    ...
    pleaseEnterBabyMonth: 'Mẹ vui lòng điền tháng tuổi',
    babyMonthCannotLower: 'Tháng tuổi của em bé không thể nhỏ hơn 1',
  },
  deal: {
    by: 'bởi',
    getDeal: 'Lấy mã',
  ...
  pregnancyProgram: {
    ...
    yourBabyMonth: 'Tháng tuổi của em bé',
    next: 'Tiếp theo',
