...
import {resendCode, verifyPhone, GlobalService} from '@services';
...
const Step3 = React.memo((props: any) => {
  ...
  return (
    <>
      <Text style={styles.txtHeader}>{t('signUp.titleSignUpStep3')}</Text>
      <Text style={styles.txtContent}>{t('signUp.contentSignUpStep3')}</Text>
