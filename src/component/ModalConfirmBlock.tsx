...
const ModalConfirmBlock = React.memo((prop: any) => {
      ...
      <View style={styles.containerModal}>
        ...
        <View style={styles.container}>
          ...
          <Text
            ...
            {t('block_user.titleModalBlock')}
          </Text>
          <AppButton
            titleButton={t('block_user.titleButtonBlock')}
            onClick={onConfirm}
            customStyleButton={[
              styles.button,
              {
