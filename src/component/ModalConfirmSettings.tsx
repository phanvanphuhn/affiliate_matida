...
const ModalConfirmSettings = React.memo((prop: any) => {
    ...
    <Modal
      ...
      <View style={styles.containerModal}>
        ...
        <View style={styles.container}>
          <SvgConfirmSettings />
          <Text style={styles.txtHeader}>{t('setting.titleConfirm')}</Text>
          <Text
            style={[
              styles.txtHeader,
              {
            ...
            {t('setting.bodyConfirm')}
          </Text>
          <AppButton
            titleButton={t('setting.save')}
            onClick={onConfirm}
            customStyleButton={[
              styles.button,
              {
