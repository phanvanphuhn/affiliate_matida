...
export const trackClickedOnPregnancyTracker = (weekSelected,optionSelected) => {
const optionText = optionSelected === 1 ? 'mom & baby' : optionSelected === 2 ? 'tips & symptoms' : 'unknown_option';
...
export const trackArticleInteraction = (articleTitle, articleSaved, clickedOnShare) => {
  const eventDetails = {
    'Article Title': articleTitle,
