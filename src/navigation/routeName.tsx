...
const ROUTE_NAME = {
  ...
  NEW_BORN: 'NEW_BORN',
  DETAIL_NEW_BORN: 'DETAIL_NEW_BORN',
  EDIT_NEW_BORN: 'EDIT_NEW_BORN',
  NEW_BORN_TRACKER: 'NEW_BORN_TRACKER',

  ADD_BABY: 'ADD_BABY',
  ADD_NEW_BABY: 'ADD_NEW_BABY',
  ADD_BABY_SUCCESS: 'ADD_BABY_SUCCESS',
  WEEKLY_CHALLENGE_COMPLETE: 'WEEKLY_CHALLENGE_COMPLETE',
  ...
  NEW_USER_PROGRAM: 'NEW_USER_PROGRAM',
